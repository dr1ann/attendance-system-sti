      ...
      try {
        ...
        data.map((schedule) => {
          ...
          const scheduleDateTime = moment(
            `${scheduleDate.format("YYYY-MM-DD")} ${schedule.scheduledInTime}`,
            "YYYY-MM-DD HH:mm"
          );
          ...
          if (scheduleDate.isSame(moment(), "day")) {
            ...
            nearestDate &&
            scheduleDate.isAfter(moment(), "day") &&
            scheduleDate.isBefore(nearestDate, "day")
          ) {
            nearestDate = scheduleDate.toDate();
          } else {
            nearestDate = scheduleDate.toDate();
    ...
    <>
      {isStudent ? (
        <div className="max-w-[2050px] mx-auto">
          ...
          <div
            id="container"
            className="p-4 lg:ml-64 min-h-screen animate-fadeUp"
          >
            {isFetchSuccessful ? (
              <>
                        ...
                        {sortLatestInOutTimes?.map((schedule: Schedule) => (
                          ...
                          >
                            ...
                            <div className="flex flex-col">
                              ...
                              <h4 className="text-xs mt-2 text-[#333333]">
                                Scheduled Time: <br />
                              </h4>
                                  ...
                                  {schedule?.canMark ? (
                                    ...
                                    <div className="flex flex-row items-center gap-1 mt-4 justify-center">
                                      ...
                                      <span className="text-center text-sm">
                                        Unavailable to mark attendance
                                      </span>
                                    </div>
                                  )}
                                </>
                                    ...
                                    <AlertDialog>
                                      ...
                                      <AlertDialogContent>
                                        <AlertDialogHeader>
                                          ...
                                          <AlertDialogDescription>
                                            Are you sure you want to cancel
                                            marking the attendance of teacher{" "}
                  ...
                  <div className="max-w-[2050px] mx-auto">
                    <div className="flex flex-col items-center justify-center min-h-screen">
                      ...
                      <span className="text-lg lg:text-xl font-semibold">
                        You currently don't have any schedule(s).
                      </span>
                    </div>
                  </div>
                )}
