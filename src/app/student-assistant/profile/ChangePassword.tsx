...
const ChangePassword: React.FC<ModalProps> = ({
  setRefetch,
  currentId,
  isVisible,
  onClose,
  ...
  const [currentPassErrorMessage, setCurrentPassErrorMessage] = useState<
    string | undefined
  >(undefined);
  const [newPassErrorMessage, setNewPassErrorMessage] = useState<
    string | undefined
  >(undefined);
  const [confNewPassErrorMessage, setConfNewPassErrorMessage] = useState<
    string | undefined
  >(undefined);
          ...
          <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="flex justify-start flex-col gap-4 items-start px-8 py-4 w-[90%]">
              <div className="flex flex-row gap-2 items-center">
                ...
                <h1 className="font-semibold text-base lg:text-lg">
                  Important Guidelines for Changing Your Password:
                </h1>
              </div>
            ...
            <form className="p-5 md:px-5 gap-4" onSubmit={handleChangePassword}>
              <div className="space-y-7 w-3/4 mx-auto">
                <div className="rounded-lg relative">
                  ...
                  <i
                    ...
                    className={`text-sm toggle-password fa-solid ${
                      currPasswordVisible ? "fa-eye" : "fa-eye-slash"
                ...
                <div className="rounded-lg relative">
                  ...
                  <i
                    ...
                    className={`text-sm toggle-password fa-solid ${
                      confNewPasswordVisible ? "fa-eye" : "fa-eye-slash"
                    } absolute top-1/2 right-0 transform -translate-y-1/2 px-2 focus:outline-none cursor-pointer`}
                  ></i>
                  {confNewPassErrorMessage && (
                    <div className="items-center gap-1 flex flex-row ml-1 absolute top-11 left-0 ">
              ...
              {isSubmitPressed ? (
                ...
                <button
                  type="submit"
                  className=" flex flex-row px-5 cursor-pointer shadow bg-transparent border-[1px] border-[#D9D9D9] hover:bg-[#D9D9D9] hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 items-center mx-auto w-fit mt-10 mb-0 gap-1 py-3 rounded-lg"
                  disabled={isSubmitPressed}
                >
                  <Image
                    src={changePasswordicon}
