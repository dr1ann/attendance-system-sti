...
<input className=" py-2 px-3 shadow drop-shadow rounded-lg font-semibold"  type="text" value={userData?.studentId || 'N/A'}  readOnly />
</label>

<label style={{ border: "1px solid #D9D9D9", borderRadius: "0.5rem" }} htmlFor="" className="relative  flex flex-col">
<span  className="absolute top-[-9px] h-fit mx-2 px-1 rounded-lg  bg-white z-20 text-xs text-[#333333]">Joined on:</span>
<input className="py-2 px-3 shadow drop-shadow rounded-lg font-semibold"  type="text" value={joinedOn} readOnly />
</label>
...
<span className="text-xs text-[#333333] text-center">{userData?.role === 'STUDENT' ?'STUDENT ASSISTANT' : 'N/A'}</span> 
</div>
<div className="flex-row lg:flex-col flex gap-6 lg:gap-2 flex-wrap">
<button  onClick={(e:React.MouseEvent<HTMLButtonElement>) => { e.preventDefault(); setIsChangeUsernameOpen(true) }} className="flex flex-row px-2 cursor-pointer items-center  mx-auto w-fit mt-2 gap-1 py-1  rounded-lg shadow  bg-transparent  border-[1px] border-[#D9D9D9]  hover:bg-[#D9D9D9]  hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0">
<Image src={changeusername} className="w-4 h-auto object-contain" alt=""/>
<span className=" font-semibold text-sm ">Change Username</span>


</button>
<button  onClick={(e:React.MouseEvent<HTMLButtonElement>) => { e.preventDefault(); setIsChangePasswordOpen(true) }} className="flex flex-row px-2 cursor-pointer items-center  mx-auto w-fit mt-2 gap-1 py-1  rounded-lg shadow  bg-transparent  border-[1px] border-[#D9D9D9]  hover:bg-[#D9D9D9]  hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0">
<Image src={changepass} className="w-4 h-auto object-contain" alt=""/>
...
<label style={{ border: "1px solid #D9D9D9", borderRadius: "0.5rem" }} htmlFor="" className="relative flex flex-col">
  ...
  <input className=" text-sm lg:text-base py-2 px-3 z-10 shadow drop-shadow rounded-lg font-semibold " type="text" value={userData?.name || 'N/A'} readOnly />

</label>

<label style={{ border: "1px solid #D9D9D9", borderRadius: "0.5rem" }} htmlFor="" className="relative flex flex-col">
  <span  className="absolute top-[-9px] h-fit mx-2 px-1 rounded-lg  bg-white z-20 text-xs text-[#333333]">Username:</span>
  <input className=" text-sm lg:text-base py-2 px-3 z-10 shadow drop-shadow rounded-lg font-semibold " type="text" value={userData?.username || 'N/A'} readOnly />
...
<input className="text-sm lg:text-base py-2 px-3 shadow drop-shadow rounded-lg font-semibold" type="text" value={userData?.academicLevel || 'N/A'} readOnly />
</label>

<label style={{ border: "1px solid #D9D9D9", borderRadius: "0.5rem" }} htmlFor="" className="relative flex flex-col">
<span  className="absolute top-[-9px] h-fit mx-2 px-1 rounded-lg  bg-white z-20 text-xs text-[#333333]">Section:</span>
<input className="text-sm lg:text-base py-2 px-3 shadow drop-shadow rounded-lg font-semibold" type="text" value={userData?.section || 'N/A'} readOnly />
</label>
</div>
...
<input className="text-sm lg:text-base py-2 px-3 shadow drop-shadow rounded-lg font-semibold"  type="text" value={userData?.program || 'N/A'} readOnly />
</label>
<label style={{ border: "1px solid #D9D9D9", borderRadius: "0.5rem" }} htmlFor="" className="relative flex flex-col">
<span  className="absolute top-[-9px] h-fit mx-2 px-1 rounded-lg  bg-white z-20 text-xs text-[#333333]">Year level :</span>
<input className="text-sm lg:text-base py-2 px-3 shadow drop-shadow rounded-lg font-semibold" type="text" value={userData?.yearLevel || 'N/A'} readOnly />
</label>
</div>
...
<label style={{ border: "1px solid #D9D9D9", borderRadius: "0.5rem" }} htmlFor="" className="relative flex flex-col">
<span  className="absolute top-[-9px] h-fit mx-2 px-1 rounded-lg  bg-white z-20 text-xs text-[#333333]">Student ID:</span>
<input className="text-sm py-2 px-3 shadow drop-shadow rounded-lg font-semibold" type="text" value={userData?.studentId || 'N/A'} readOnly />
</label>

<label style={{ border: "1px solid #D9D9D9", borderRadius: "0.5rem" }} htmlFor="" className="relative flex flex-col">
<span  className="absolute top-[-9px] h-fit mx-2 px-1 rounded-lg  bg-white z-20 text-xs text-[#333333]">Joined on:</span>
<input className="text-sm py-2 px-3 shadow drop-shadow rounded-lg font-semibold"  type="text" value={joinedOn} readOnly />
</label>
</div>
...
<ChangeUsername setRefetch={() =>  setRefetch(true)} isVisible={isChangeUsernameOpen} currentId={userData?.id} currentUsername={userData?.username} onClose={() => setIsChangeUsernameOpen(false)}  />

<ChangePassword setRefetch={() =>  setRefetch(true)} isVisible={isChangePasswordOpen} currentId={userData?.id} onClose={() => setIsChangePasswordOpen(false)}  />
</div>
<Footer />
