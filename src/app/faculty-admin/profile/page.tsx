...
<div className="grid grid-cols-2 gap-4 mt-4 lg:mt-8">   
<label style={{ border: "1px solid #D9D9D9", borderRadius: "0.5rem" }} htmlFor="" className="relative flex flex-col">
  <span  className="absolute top-[-9px] h-fit mx-2 px-1 rounded-lg  bg-white z-20 text-xs text-[#333333]">Faculty ID:</span>
  <input className=" text-sm lg:text-base py-2 px-3 z-10 shadow drop-shadow rounded-lg font-semibold " type="text" value={userData?.studentId || 'N/A'}readOnly />

</label>

<label style={{ border: "1px solid #D9D9D9", borderRadius: "0.5rem" }} htmlFor="" className="relative flex flex-col">
  <span  className="absolute top-[-9px] h-fit mx-2 px-1 rounded-lg  bg-white z-20 text-xs text-[#333333]">Joined on:</span>
  <input className=" text-sm lg:text-base py-2 px-3 z-10 shadow drop-shadow rounded-lg font-semibold " type="text" value={joinedOn} readOnly />
