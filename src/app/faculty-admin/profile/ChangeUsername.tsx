...
const ChangeUsername: React.FC<ModalProps> = ({
  setRefetch,
  currentId,
  currentUsername,
  isVisible,
            ...
            <div className="flex justify-start flex-col gap-4 items-start px-8 py-4 w-[90%]">
              <div className="flex flex-row gap-2 items-center">
                ...
                <h1 className="font-semibold text-base lg:text-lg">
                  Important Guidelines for Changing Your Username:
                </h1>
              </div>
            ...
            <form className="p-5 md:px-5 gap-4" onSubmit={handleChangeUsername}>
                ...
                <div className="rounded-lg relative">
                  ...
                  {errorMessage && (
                    <div className="items-center gap-1 flex flex-row ml-1 absolute top-11 left-0">
                      ...
                      <p className="text-[#ff0000] text-xs">{errorMessage}</p>
                    </div>
                  )}
                </div>
              </div>
              {isSubmitPressed ? (
                ...
                >
                  <Image
                    src={changeUsernameicon}
                    className="w-4 mt-[2px] h-auto object-contain"
                    alt=""
                  />
