...
export default function StudentAssistants({
  ...
  const [sortOption, setSortOption] = useState<"name" | "newest" | "oldest">(
    "name"
  );
    ...
    <>
      {isAdmin ? (
        <div className="max-w-[2050px] mx-auto">
          <Header
            headingImg={studentassistants}
            headingName="STUDENT ASSISTANTS"
          />
          <Sidebar />
                  ...
                  <div className="p-0 lg:p-4 overflow-y-auto mt-[3em] lg:mt-[4em] rounded-lg">
                    <div className="lg:hidden animate-fadeUp">
                      <div className="flex flex-row justify-between items-center">
                        <form className="flex flex-row items-center w-fit space-x-2">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setSortOption(
                                e.target.value as "name" | "newest" | "oldest"
                              )
                            }
                          >
                      ...
                      <button
                        ...
                        className="shadow  bg-transparent  border-[1px] border-[#D9D9D9]  hover:bg-[#D9D9D9]  hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 w-fit ml-auto  my-6  rounded-lg px-3 py-1 mr-2 cursor-pointer flex  justify-center flex-row items-center gap-1"
                      >
                            ...
                            {paginatedEntries?.map(
                              (student: User, index: number) => (
                                <li
                                  ...
                                  className="flex flex-wrap flex-col  gap-3 p-3 rounded-lg shadow drop-shadow"
                                >
                                  <div className="flex flex-row justify-between items-center gap-8">
                                    <Image
                                      ...
                                      className="flex w-16 px-2 h-auto"
                                      alt=""
                                    />
                                  ...
                                  <div className="flex flex-row space-x-2">
                                    <div className="flex flex-col ">
                                      ...
                                      <div className="flex flex-row items-center mt-2 space-x-1">
                                        <h4 className="text-xs  text-[#333333]">
                                          Student ID:{" "}
                                        </h4>
                                      ...
                                      <div className="flex flex-row items-center space-x-3">
                                        ...
                                        <button
                                          onClick={(e) =>
                                            handleMoreInfoClick(e, student?.id)
                                          }
                                          className=" bg-transparent  border-[1px] border-[#D9D9D9]  hover:bg-[#D9D9D9]  hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 shadow  w-fit ml-3   rounded-lg px-2 py-1 cursor-pointer flex  justify-center flex-row items-center gap-1"
                                        >
                                  ...
                                  <div className="flex gap-2 flex-row flex-wrap mt-5 items-center">
                                    <button
                                      ...
                                      className=" bg-transparent  border-[1px] border-[#D9D9D9]  hover:bg-[#D9D9D9]  hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 shadow  w-fit   rounded-lg px-2 py-1 cursor-pointer flex  justify-center flex-row items-center gap-1"
                                    >
                                      <i className="fa-solid fa-calendar-plus text-center text-xs text-[#2C384A]"></i>
                                    </button>
                                    <button
                                      onClick={(e) =>
                                        handleScheduleInfoClick(
                                          e,
                                          student?.id,
                                          student?.name
                                        )
                                      }
                                      className=" bg-transparent  border-[1px] border-[#D9D9D9] mr-4  hover:bg-[#D9D9D9]  hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 shadow  w-fit   rounded-lg px-2 py-1 cursor-pointer flex  justify-center flex-row items-center gap-1"
                                    >
                                    ...
                                    <button
                                      ...
                                      className=" bg-transparent  border-[1px] border-[#D9D9D9] ml-auto  hover:bg-[#D9D9D9]  hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 shadow  w-fit   rounded-lg px-2 py-1 cursor-pointer flex  justify-center flex-row items-center gap-1"
                                    >
                        ...
                        <table className="table-auto rounded-lg w-fit mx-auto text-black text-left rtl:text-right">
                          <thead className="bg-[#2C384A] shadow drop-shadow rounded-lg">
                            <tr className=" shadow drop-shadow ">
                              <th
                                scope="col"
                                className="px-4 py-2 text-center text-base text-white shadow drop-shadow"
                              >
                                NAME & ID
                              </th>
                              <th
                              ...
                              <th
                                scope="col"
                                className="text-center px-4 py-2 text-base text-white shadow drop-shadow"
                              >
                                SCHEDULES
                              </th>
                              <th
                                scope="col"
                                className="px-4 py-2 text-center text-white text-base shadow drop-shadow"
                              >
                                ACTIVITY
                              </th>
                              <th
                            ...
                            {paginatedEntries?.map(
                              (student: User, index: number) => (
                                <tr key={index}>
                                  <th
                                    scope="row"
                                    className=" px-4 py-2 font-normal text-base bg-gray-100 h-full  shadow drop-shadow  "
                                  >
                                    <div className="flex flex-row  gap-3 items-center">
                                      <Image
                                        ...
                                        className="self-center w-14 h-14"
                                        alt=""
                                      />
                                      <div className="flex flex-col">
                                        <h3 className="font-bold text-lg">
                                        ...
                                        <div className="flex flex-col">
                                          <span className="text-[.70rem] leading-3  text-[#333333] ">
                                            Student ID: <br />
                                          </span>
                                          <h4 className="font-semibold text-[.85rem] leading-4 ">
                  ...
                  <div className="max-w-[2050px] mx-auto">
                    <div className="flex flex-col items-center justify-center min-h-screen">
                      ...
                      <Image
                        ...
                        alt="access denied"
                      />
                      <span className="mb-4 text-sm lg:text-base font-semibold">
                        No student assistants registered at the moment.
                      </span>
                      <button
                        onClick={(e: React.MouseEvent<HTMLButtonElement>) => {
                          e.preventDefault();
          ...
          <AddNewSchedule
            ...
            studentName={currentStudentName}
            setRefetch={() => setRefetch(true)}
            isVisible={isAddNewScheduleOpen}
            onClose={() => setIsAddNewScheduleOpen(false)}
          />
          <ActivityLog
            studentId={currentStudentId}
            studentName={currentStudentName}
            isVisible={isActivityLogOpen}
