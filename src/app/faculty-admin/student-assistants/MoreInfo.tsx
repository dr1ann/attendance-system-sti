...
const MoreInfo: React.FC<ModalProps> = ({
  setRefetch,
  currentId,
  isVisible,
  onClose,
}) => {
  const [originalStudentInfo, setOriginalStudentInfo] = useState<User | null>(
    null
  );
  ...
  const updateStudentInfo = async () => {
    try {
      ...
      const hasChanges = Object.keys(studentInfo || {}).some((key: string) => {
        ...
        return (
          (studentInfo as User)[studentKey] !==
          (originalStudentInfo as User)[studentKey]
        );
      });
          ...
          <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t gap-2">
              <h3 className="text-lg lg:text-xl font-bold text-gray-900">
                <i className="fa-solid fa-circle-info text-base lg:text-lg text-center text-[#2C384A]"></i>{" "}
                {`${originalStudentInfo?.name || ""}'s Info`}
              </h3>
              <button
                onClick={(e) => {
                  e.preventDefault();
            ...
            {!isFetchSuccessful ? (
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Are you sure you want to discard your changes? Any
                ...
                >
                  <div
                    className={`grid grid-cols-2 gap-4 ${
                      isNameEmpty || isStudentIdEmpty || studentIdError
                  ...
                  <div
                    className={`grid grid-cols-2 gap-4 mt-6 ${
                      isProgramEmpty || isYearLevelEmpty
                        ? "mb-[45px] smallscreens:mb-[35px] lg:mb-[30px]"
                        : ""
                    }`}
                  >
              ...
              focus:border-[#01579B] appearance-none focus:outline-none focus:ring-0 peer`}
                        ...
                        <label
                          htmlFor="gender"
                          className="text-[#888] peer-focus:text-[#01579B] bg-gray-100 rounded-full tracking-wide absolute text-xs lg:text-sm duration-150 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-[0.625rem] peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1"
                        >
                          Sex
                        </label>
                      </div>
                    ...
                    <div className="rounded-lg relative bg-gray-100">
                      ...
                      <label
                        htmlFor="joinedOn"
                        className="bg-gray-100 rounded-full text-[#888] peer-focus:text-[#01579B] tracking-wide absolute text-xs lg:text-sm duration-150 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-[0.625rem] peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1"
                      >
                        Joined on
                      </label>
                    </div>
                  ...
                  {isEditMode && (
                    <>
                      {isSavePressed ? (
                        <button
                          type="submit"
                          className="flex flex-row px-5 cursor-not-allowed shadow  bg-transparent  border-[1px] border-[#D9D9D9]    hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 items-center mx-auto w-fit mt-6 gap-1 py-3 rounded-lg"
                        ...
                        <>
                          {isEditMode && (
                            <button
                              type="submit"
                              className="flex flex-row px-5 cursor-pointer shadow  bg-transparent  border-[1px] border-[#D9D9D9]  hover:bg-[#D9D9D9]  hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 items-center mx-auto w-fit mt-6 gap-1 py-3 rounded-lg"
                              disabled={isSavePressed}
                            >
