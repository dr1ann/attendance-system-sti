...
const AddNewSchedule: React.FC<ModalProps> = ({
  setRefetch,
  isVisible,
  onClose,
  studentId,
  ...
  const handleAddSchedule = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isValid) {
      ...
      const combinedDateTime = combineDateTime(
        trimmedScheduleData.scheduledDate,
        trimmedScheduleData.scheduledInTime
      );
            ...
            <div className="relative bg-white rounded-lg shadow">
              ...
              <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t gap-2">
                <h3 className="text-lg lg:text-xl font-bold text-gray-900">
                  <i className="fa-solid fa-calendar-plus text-base lg:text-lg text-center text-[#2C384A]"></i>{" "}
                  {"Add New Schedule for " + studentName}
                </h3>
                <button
                  onClick={(e) => {
                    e.preventDefault();
              ...
              >
                <div
                  className={`grid grid-cols-2 gap-4 mt-3 ${
                    isTeacherNameEmpty || isScheduledDateEmpty
                ...
                <div
                  className={`grid grid-cols-2 gap-4 mt-3 ${
                    isScheduledInTimeEmpty || isScheduledOutTimeEmpty
                      ? "mb-[45px] smallerscreens:mb-[35px] lg:mb-[30px]"
                      : ""
                  }`}
                >
