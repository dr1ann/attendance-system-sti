        ...
        {isModalOpen && (
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Removing this student will permanently delete their data from
                the system. This action cannot be undone. Please confirm if you
                wish to proceed.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
                ...
                <div className="flex animate-fadeUp z-[99999] min-h-screen  m-auto overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 bottom-0 justify-center items-center w-full md:inset-0 max-h-full">
                  <div
                    ...
                    className={`animate-fadeUp absolute bottom-0 flex items-center p-4 mb-4 ${
                      isStudentRemoved ? "text-[#28a745]" : "text-[#ff0000]"
                    } rounded-lg ${
                      isStudentRemoved ? "bg-green-50" : "bg-red-50"
                    }`}
                    role="alert"
                  >
                    <i
                      className={`${
                        isStudentRemoved ? "text-[#28a745]" : "text-[#ff0000]"
                      } fa-solid ${isStudentRemoved ? "fa-check" : "fa-times"}`}
                    ></i>
                    <span className="sr-only">
                      {isStudentRemoved ? "Success" : "Error"}
                    </span>
