...
const RemoveSchedulesByDate: React.FC<ModalProps> = ({
  selectedDate,
  setRefetch,
  formatDate,
  onSelectDate,
    ...
    <>
      <div className="flex flex-row items-center justify-center gap-6">
        <DatePicker
          ...
          customInput={
            <CustomDateInput value={selectedDate} onClick={() => {}} />
        ...
        <AlertDialog key={key}>
          ...
          {isModalOpen && (
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>
                  Are you sure you want to delete all schedules for{" "}
                  {formatDate(selectedDate)}?
                </AlertDialogTitle>
                <AlertDialogDescription>
                  Deleting all schedules for this date will permanently remove
                  them from the system. This action cannot be undone. Please
                  ...
                  <div className="flex animate-fadeUp z-[99999] min-h-screen m-auto overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 bottom-0 justify-center items-center w-full md:inset-0 max-h-full">
                    ...
                    >
                      ...
                      <div className="ms-3 text-sm font-medium">
                        {isScheduleRemoved
                          ? "All schedules were removed successfully"
                          : removeError}
                      </div>
                    </div>
                  </div>
