import {
  ExportAllActivityLog,
  ExportAllStudents,
} from "@/app/components/ExportToExcel";
...
const ActivityLogList = () => {
  ...
  return (
    <div className="flex flex-col">
      {isExportBtnPressed ? (
        <button
          disabled={isExportBtnPressed}
          className="shadow bg-transparent border-[1px] border-[#D9D9D9] hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 cursor-not-allowed gap-1 flex items-center justify-center p-2 rounded-lg "
        >
        ...
        <button
          ...
          disabled={isExportBtnPressed}
          className="shadow bg-transparent border-[1px] border-[#D9D9D9] hover:bg-[#D9D9D9] hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 cursor-pointer gap-1 flex items-center justify-center p-2 rounded-lg "
        >
